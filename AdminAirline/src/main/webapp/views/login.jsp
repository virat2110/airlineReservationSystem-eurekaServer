...
<%@include file="nava.jsp" %>
    ...
    <form  action="LoginData" method="post">
        ...
        <input type = "submit" value="sign in" class="btn"/>
          ...
          <%
          String img = "https://github.com/virat2110/BMI-CALCULATOR-WITH-NUTRION-CHART-AND-PROFILE-UPDATE/blob/main/2.png?raw=true";
          %>
          
        </form>
         <div class="image">
         <img alt="no image" src=<%=img %> height="300px"/>
